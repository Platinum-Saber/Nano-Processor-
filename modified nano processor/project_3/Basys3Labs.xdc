...
set_property PACKAGE_PIN W18 [get_ports {compare[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {compare[0]}]
set_property PACKAGE_PIN U15 [get_ports {compare[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {compare[1]}]
set_property PACKAGE_PIN U14 [get_ports {compare[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {compare[2]}]
